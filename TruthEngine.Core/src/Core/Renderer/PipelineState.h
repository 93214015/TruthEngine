...
constexpr RendererStateSet InitRenderStates(
	TE_RENDERER_STATE_ENABLED_SHADER_HS enabledHS = TE_RENDERER_STATE_ENABLED_SHADER_HS_FALSE 
	...
	, TE_RENDERER_STATE_ENABLED_MAP_SPECULAR enabledSpecularMap = TE_RENDERER_STATE_ENABLED_MAP_SPECULAR_FALSE 
	, TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS enabledRoughnessMap = TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_METALLIC enabledMetallicMap = TE_RENDERER_STATE_ENABLED_MAP_METALLIC_FALSE 
	, TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION enabledAmbientOcclusionMap = TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION_FALSE
	...
	, TE_RENDERER_STATE_ENABLED_HDR enabledHDR = TE_RENDERER_STATE_ENABLED_HDR_FALSE 
	, TE_RENDERER_STATE_SHADING_MODEL shadingModel = TE_RENDERER_STATE_SHADING_MODEL_BLINNPHONG
