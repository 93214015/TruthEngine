...
#define GET_RENDERER_STATE(states, stateName) ((states >> BIT_POS_##stateName) & ((1 << BIT_NUM_##stateName) - 1))
#define SET_RENDERER_STATE(states, stateName, stateValue) states = ((states & ~(BIT_MASK_##stateName) ) | (stateValue << BIT_POS_##stateName))
#define COMPARE_RENDERER_STATE(states, stateName, stateValue) (GET_RENDERER_STATE(states, stateName)) == stateValue  
...
#define BIT_NUM_TE_RENDERER_STATE_ENABLED_MAP_SPECULAR 1
enum TE_RENDERER_STATE_ENABLED_MAP_SPECULAR : RendererStateSet
{
	TE_RENDERER_STATE_ENABLED_MAP_SPECULAR_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_MAP_SPECULAR_TRUE = 1
};

#define BIT_NUM_TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS 1
enum TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS : RendererStateSet
{
	TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS_TRUE = 1
};

#define BIT_NUM_TE_RENDERER_STATE_ENABLED_MAP_METALLIC 1
enum TE_RENDERER_STATE_ENABLED_MAP_METALLIC : RendererStateSet
{
	TE_RENDERER_STATE_ENABLED_MAP_METALLIC_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_MAP_METALLIC_TRUE = 1
};

#define BIT_NUM_TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION 1
enum TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION : RendererStateSet
{
	TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION_TRUE = 1
};
...
#define BIT_NUM_TE_RENDERER_STATE_ENABLED_HDR 1
enum TE_RENDERER_STATE_ENABLED_HDR
{
	TE_RENDERER_STATE_ENABLED_HDR_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_HDR_TRUE = 1,
};

#define BIT_NUM_TE_RENDERER_STATE_SHADING_MODEL 4
enum TE_RENDERER_STATE_SHADING_MODEL
{
	TE_RENDERER_STATE_SHADING_MODEL_NONE = 0,
	TE_RENDERER_STATE_SHADING_MODEL_BLINNPHONG = 1,
	TE_RENDERER_STATE_SHADING_MODEL_PBR = 2,
};

#define BIT_NUM_TE_RENDERER_STATE_ENABLED_BLEND 1
enum TE_RENDERER_STATE_ENABLED_BLEND
{
	TE_RENDERER_STATE_ENABLED_BLEND_FALSE = 0,
	TE_RENDERER_STATE_ENABLED_BLEND_TRUE = 1,
};
...
enum BIT_POS : RendererStateSet
{
	...
	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_MAP_SPECULAR, TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS, TE_RENDERER_STATE_ENABLED_MAP_SPECULAR),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_MAP_METALLIC, TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION, TE_RENDERER_STATE_ENABLED_MAP_METALLIC),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_FRONTCOUNTERCLOCKWISE, TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION),
	...
	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_HDR, TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_SHADING_MODEL, TE_RENDERER_STATE_ENABLED_HDR),

	WRITE_ENUM_BIT_POS(TE_RENDERER_STATE_ENABLED_BLEND, TE_RENDERER_STATE_SHADING_MODEL),
...
enum BIT_MASK : RendererStateSet
{
	...
	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_MAP_SPECULAR),

	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS),

	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_MAP_METALLIC),

	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION),
	...
	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_HDR),

	WRITE_ENUM_MASK(TE_RENDERER_STATE_SHADING_MODEL),

	WRITE_ENUM_MASK(TE_RENDERER_STATE_ENABLED_BLEND),

};

constexpr RendererStateSet InitRenderStates(TE_RENDERER_STATE_ENABLED_SHADER_HS enabledHS = TE_RENDERER_STATE_ENABLED_SHADER_HS_FALSE , TE_RENDERER_STATE_ENABLED_SHADER_DS enabledDS = TE_RENDERER_STATE_ENABLED_SHADER_DS_FALSE
	, TE_RENDERER_STATE_ENABLED_SHADER_GS enabledGS = TE_RENDERER_STATE_ENABLED_SHADER_GS_FALSE , TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE enabledDiffuseMap = TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_NORMAL enabledMapNormal = TE_RENDERER_STATE_ENABLED_MAP_NORMAL_FALSE , TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT enabledDisplacementMap = TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_SPECULAR enabledSpecularMap = TE_RENDERER_STATE_ENABLED_MAP_SPECULAR_FALSE , TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS enabledRoughnessMap = TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_METALLIC enabledMetallicMap = TE_RENDERER_STATE_ENABLED_MAP_METALLIC_FALSE , TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION enabledAmbientOcclusionMap = TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION_FALSE
	, TE_RENDERER_STATE_FRONTCOUNTERCLOCKWISE frontClockWise = TE_RENDERER_STATE_FRONTCOUNTERCLOCKWISE_FALSE , TE_RENDERER_STATE_ENABLED_DEPTH enabledDepth = TE_RENDERER_STATE_ENABLED_DEPTH_TRUE
	, TE_RENDERER_STATE_ENABLED_STENCIL enabledStencil = TE_RENDERER_STATE_ENABLED_STENCIL_FALSE , TE_RENDERER_STATE_FILL_MODE fillMode = TE_RENDERER_STATE_FILL_MODE_SOLID
	, TE_RENDERER_STATE_CULL_MODE cullMode = TE_RENDERER_STATE_CULL_MODE_BACK , TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY primitiveTopology = TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY_TRIANGLELIST
	, TE_RENDERER_STATE_ENABLED_HDR enabledHDR = TE_RENDERER_STATE_ENABLED_HDR_FALSE , TE_RENDERER_STATE_SHADING_MODEL shadingModel = TE_RENDERER_STATE_SHADING_MODEL_BLINNPHONG
	, TE_RENDERER_STATE_ENABLED_BLEND enabledBlend = TE_RENDERER_STATE_ENABLED_BLEND_FALSE)
{
	...
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_MAP_SPECULAR, enabledSpecularMap);
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS, enabledRoughnessMap);
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_MAP_METALLIC, enabledMetallicMap);
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION, enabledAmbientOcclusionMap);
	...
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_HDR, enabledHDR);
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_SHADING_MODEL, shadingModel);
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_BLEND, enabledBlend);

	return states;
}

constexpr RendererStateSet InitRenderStates_CCW(TE_RENDERER_STATE_ENABLED_SHADER_HS enabledHS = TE_RENDERER_STATE_ENABLED_SHADER_HS_FALSE , TE_RENDERER_STATE_ENABLED_SHADER_DS enabledDS = TE_RENDERER_STATE_ENABLED_SHADER_DS_FALSE
	, TE_RENDERER_STATE_ENABLED_SHADER_GS enabledGS = TE_RENDERER_STATE_ENABLED_SHADER_GS_FALSE , TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE enabledDiffuseMap = TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_NORMAL enabledMapNormal = TE_RENDERER_STATE_ENABLED_MAP_NORMAL_FALSE , TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT enabledDisplacementMap = TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_SPECULAR enabledSpecularMap = TE_RENDERER_STATE_ENABLED_MAP_SPECULAR_FALSE , TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS enabledRoughnessMap = TE_RENDERER_STATE_ENABLED_MAP_ROUGHNESS_FALSE
	, TE_RENDERER_STATE_ENABLED_MAP_METALLIC enabledMetallicMap = TE_RENDERER_STATE_ENABLED_MAP_METALLIC_FALSE , TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION enabledAmbientOcclusionMap = TE_RENDERER_STATE_ENABLED_MAP_AMBIENTOCCLUSION_FALSE
	, TE_RENDERER_STATE_ENABLED_DEPTH enabledDepth = TE_RENDERER_STATE_ENABLED_DEPTH_TRUE , TE_RENDERER_STATE_ENABLED_STENCIL enabledStencil = TE_RENDERER_STATE_ENABLED_STENCIL_FALSE
	, TE_RENDERER_STATE_FILL_MODE fillMode = TE_RENDERER_STATE_FILL_MODE_SOLID , TE_RENDERER_STATE_CULL_MODE cullMode = TE_RENDERER_STATE_CULL_MODE_BACK
	, TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY primitiveTopology = TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY_TRIANGLELIST , TE_RENDERER_STATE_ENABLED_HDR enabledHDR = TE_RENDERER_STATE_ENABLED_HDR_FALSE
	, TE_RENDERER_STATE_SHADING_MODEL shadingModel = TE_RENDERER_STATE_SHADING_MODEL_BLINNPHONG , TE_RENDERER_STATE_ENABLED_BLEND enabledBlend = TE_RENDERER_STATE_ENABLED_BLEND_FALSE)
{
	RendererStateSet states = InitRenderStates(enabledHS, enabledDS, enabledGS, enabledDiffuseMap
		, enabledMapNormal, enabledDisplacementMap, enabledSpecularMap, enabledRoughnessMap, enabledMetallicMap
		, enabledAmbientOcclusionMap, TE_RENDERER_STATE_FRONTCOUNTERCLOCKWISE_TRUE, enabledDepth, enabledStencil, fillMode
		, cullMode, primitiveTopology, enabledHDR, shadingModel, enabledBlend
	);
