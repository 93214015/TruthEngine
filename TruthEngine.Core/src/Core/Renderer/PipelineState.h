...
enum TE_RENDERER_STATE_ENABLED_SHADER_HS
{
...
enum TE_RENDERER_STATE_ENABLED_SHADER_DS
{
...
enum TE_RENDERER_STATE_ENABLED_SHADER_GS
{
...
enum TE_RENDERER_STATE_FRONTCOUNTERCLOCKWISE
{
...
enum TE_RENDERER_STATE_ENABLED_DEPTH
{
...
enum TE_RENDERER_STATE_ENABLED_STENCIL
{
...
enum TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE
{
...
enum TE_RENDERER_STATE_ENABLED_MAP_NORMAL
{
...
enum TE_RENDERER_STATE_ENABLED_MAP_DISPLACEMENT
{
...
enum TE_RENDERER_STATE_CULL_MODE
{
...
enum TE_RENDERER_STATE_FILL_MODE
{
...
enum TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY
{
...
constexpr RendererStateSet InitRenderStates(TE_RENDERER_STATE_ENABLED_SHADER_HS enabledHS = TE_RENDERER_STATE_ENABLED_SHADER_HS_FALSE
	...
	, TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE enabledDisplacementMap = TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE_FALSE
	...
	, TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY primitiveTopology = TE_RENDERER_STATE_PRIMITIVE_TOPOLOGY_TRIANGLELIST)
{
	...
	SET_RENDERER_STATE(states, TE_RENDERER_STATE_ENABLED_MAP_DIFFUSE, enabledDisplacementMap);
