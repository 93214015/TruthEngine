...
enum TE_RESOURCE_USAGE : TE_FLAG_TYPE {
	...
	TE_RESOURCE_USAGE_CONSTANTBUFFER = (1 << 3),
	TE_RESOURCE_USAGE_UNORDEREDACCESS = (1 << 4),
	TE_RESOURCE_USAGE_VERTEXBUFFER = (1 << 5),
	TE_RESOURCE_USAGE_INDEXBUFFER = (1 << 6),
	TE_RESOURCE_USAGE_INTERMEDIATEUPLOADBBUFFER = (1 << 7),
	TE_RESOURCE_USAGE_STRUCTUREDBUFFER = (1 << 8) | TE_RESOURCE_USAGE_SHADERRESOURCE
};
TE_DEFINE_ENUM_FLAG_OPERATORS(TE_RESOURCE_USAGE);
