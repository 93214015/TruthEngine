...
TruthEngine::Core::Buffer::Buffer(size_t sizeInByte, TE_RESOURCE_USAGE usage, TE_RESOURCE_STATES initState)
...
const void* TruthEngine::Core::Buffer::GetDataPtr(uint8_t frameIndex) const noexcept
{
