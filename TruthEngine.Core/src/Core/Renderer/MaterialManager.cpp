...
namespace TruthEngine::Core
{
	...
	TruthEngine::Core::Material* MaterialManager::AddMaterial(Material* material)
	{
		...
		auto _newMaterial = std::make_shared<Material>(ID, material->m_RendererStates, material->m_ColorDiffuse, material->m_FresnelR0, material->m_Shininess, material->m_MapIndexDiffuse, material->m_MapIndexNormal, material->m_MapIndexDisplacement, material->m_ExtraDepthBias, material->m_ExtraSlopeScaledDepthBias, material->m_ExtraDepthBiasClamp, material->m_MeshType);
