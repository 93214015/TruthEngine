...
namespace TruthEngine::Core
{
	...
	Mesh::Mesh(uint32_t IndexNum, size_t IndexOffset, size_t VertexOffset, Material* MaterialPtr, VertexBuffer<VertexData::Pos, VertexData::NormTex>* VertexBufferPtr, IndexBuffer* IndexBufferPtr)
