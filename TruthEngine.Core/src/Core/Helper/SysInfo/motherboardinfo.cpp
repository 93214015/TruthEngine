...
std::string& MotherboardInfo::name() 
{
	return this->_name;
}
...
std::string& MotherboardInfo::manufacturer() 
{
...
std::string& MotherboardInfo::chipset() 
{
...
std::string& MotherboardInfo::serialNumber() 
{
...
std::string& MotherboardInfo::version() 
{
