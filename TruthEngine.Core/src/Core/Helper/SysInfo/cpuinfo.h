...
public:
    ...
    std::string& L3CacheSizeStr();
    uint32_t L3CacheSize()const;
	std::string name() const;
	std::string manufacturer() const;
	std::string numberOfCores() const;
	std::string architecture() const;
	std::string L2CacheSizeStr() const;
	std::string L3CacheSizeStr() const;
...
private:
    ...
    std::string _L2CacheSizeStr;
    std::string _L3CacheSizeStr;
    uint32_t _L2CacheSize;
    uint32_t _L3CacheSize;
	int _cpuNumber;
